...
YAHOO.lang.extend(WireIt.Wire, WireIt.CanvasElement, {
    ...
    setOptions: function(options) {
        ...
        this.options.borderwidth = options.borderwidth || 2;
...
//       console.log(JSON.stringify(this.terminal1.container.options.idcomp));
//       console.log(JSON.stringify(this.terminal2.container.options.idcomp));
//        if (this.terminal1.container.options.xtype == "WireIt.InOutContainer" || this.terminal2.container.options.xtype === "WireIt.InOutContainer") {
        console.log("Trigger Data Mapping!");
        console.log("queryIdInput: " + this.terminal1.container.options.idcomp);
        console.log("targetIdInput: " + this.terminal2.container.options.idcomp);
        console.log("clicked-wire: " + this.wireID);
        ...
        if (this.terminal1.container.options.xtype === "WireIt.InOutContainer" && this.terminal2.container.options.xtype === "WireIt.InOutContainer") {
            ...
            document.getElementById('targetIdInput').value = this.terminal2.container.options.idcomp;
            ...
            document.getElementById('operationName').value = this.terminal1.container.options.idcomp;
