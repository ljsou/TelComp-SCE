...
//                "offsetPosition": {"left": -14, "top": 3 + 30 * (i + 1)},
                "offsetPosition": {"left": -14, "top": 20 * (i + 1)},
                "ddConfig": {
                    "type": "input",
                    "allowedTypes": ["output"]
                }
            });
            this.bodyEl.appendChild(WireIt.cn('div', null, {lineHeight: "15px"}, input));
        }
...
//                "offsetPosition": {"right": -14, "top": 3 + 30 * (i + 1 + this.options.inputs.length)},
                "offsetPosition": {"right": -14, "top": 20 * (i + 1 + this.options.inputs.length)},
                "ddConfig": {
                    "type": "output",
                    "allowedTypes": ["input"]
                },
            ...
            this.bodyEl.appendChild(WireIt.cn('div', null, {lineHeight: "23px", textAlign: "right"}, output));
        }
